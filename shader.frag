...
vec2 sdf_scene(vec3 p) {
    ...
    // Vitesse angulaire de Mercure (Kepler 2: variation de vitesse orbitale)
    ...
    // Coordonnées de Mercure sur son orbite elliptique
    ...
    // Position de Mercure sur son orbite elliptique
    ...
    // Vitesse angulaire de Vénus (Kepler 2: variation de vitesse orbitale)
    ...
    // Coordonnées de Vénus sur son orbite elliptique
    ...
    // Position de Vénus sur son orbite elliptique
    ...
    // Vitesse angulaire de la Terre (Kepler 2: variation de vitesse orbitale)
    ...
    // Position de la Terre sur son orbite elliptique
    ...
    // Vitesse angulaire de Mars (Kepler 2: variation de vitesse orbitale)
    ...
    // Coordonnées de Mars sur son orbite elliptique
    ...
    // Position de Mars sur son orbite elliptique
    ...
    // Vitesse angulaire de Jupiter (Kepler 2: variation de vitesse orbitale)
    ...
    // Coordonnées de Jupiter sur son orbite elliptique
    ...
    // Vitesse angulaire de Saturne (Kepler 2: variation de vitesse orbitale)
    ...
    // Coordonnées de Saturne sur son orbite elliptique
    ...
    // Position de Saturne sur son orbite elliptique
    ...
    // Vitesse angulaire d'Uranus (Kepler 2: variation de vitesse orbitale)
    ...
    // Coordonnées d'Uranus sur son orbite elliptique
    ...
    // Vitesse angulaire de Neptune (Kepler 2: variation de vitesse orbitale)
    ...
    // Coordonnées de Neptune sur son orbite elliptique
    ...
    // Position de Neptune sur son orbite elliptique
...
void main() {
    ...
    //vec3 starColor = starNest(ro, rd); // Rendu des étoiles
    vec3 starColor = texture(u_texture_stars, f_uv).rgb;
    vec3 col = starColor;
